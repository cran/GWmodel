...
// new_multiscale
Rcpp::List new_multiscale(Eigen::MatrixXd x, Eigen::MatrixXd x1, Rcpp::List dMatsParam, Eigen::MatrixXd dp_locat, Eigen::VectorXd y, Eigen::Matrix<double, Eigen::Dynamic, 1> bws0, std::vector<int> var_dMat_index, bool adaptive, bool verbose, int nlower, bool hatmatrix, int max_iterations, double threshold, int max_threads, std::vector<std::string> variable_names, int kerneln, int approachn, int crin, int bws_reOpts);
RcppExport SEXP _GWmodel_new_multiscale(SEXP xSEXP, SEXP x1SEXP, SEXP dMatsParamSEXP, SEXP dp_locatSEXP, SEXP ySEXP, SEXP bws0SEXP, SEXP var_dMat_indexSEXP, SEXP adaptiveSEXP, SEXP verboseSEXP, SEXP nlowerSEXP, SEXP hatmatrixSEXP, SEXP max_iterationsSEXP, SEXP thresholdSEXP, SEXP max_threadsSEXP, SEXP variable_namesSEXP, SEXP kernelnSEXP, SEXP approachnSEXP, SEXP crinSEXP, SEXP bws_reOptsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter< Eigen::MatrixXd >::type x(xSEXP);
  Rcpp::traits::input_parameter< Eigen::MatrixXd >::type x1(x1SEXP);
  Rcpp::traits::input_parameter< Rcpp::List >::type dMatsParam(dMatsParamSEXP);
  Rcpp::traits::input_parameter< Eigen::MatrixXd >::type dp_locat(dp_locatSEXP);
  Rcpp::traits::input_parameter< Eigen::VectorXd >::type y(ySEXP);
  Rcpp::traits::input_parameter< Eigen::Matrix<double, Eigen::Dynamic, 1> >::type bws0(bws0SEXP);
  Rcpp::traits::input_parameter< std::vector<int> >::type var_dMat_index(var_dMat_indexSEXP);
  Rcpp::traits::input_parameter< bool >::type adaptive(adaptiveSEXP);
  Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
  Rcpp::traits::input_parameter< int >::type nlower(nlowerSEXP);
  Rcpp::traits::input_parameter< bool >::type hatmatrix(hatmatrixSEXP);
  ...
  Rcpp::traits::input_parameter< int >::type kerneln(kernelnSEXP);
  Rcpp::traits::input_parameter< int >::type approachn(approachnSEXP);
  Rcpp::traits::input_parameter< int >::type crin(crinSEXP);
  Rcpp::traits::input_parameter< int >::type bws_reOpts(bws_reOptsSEXP);
  rcpp_result_gen = Rcpp::wrap(new_multiscale(x, x1, dMatsParam, dp_locat, y, bws0, var_dMat_index, adaptive, verbose, nlower, hatmatrix, max_iterations, threshold, max_threads, variable_names, kerneln, approachn, crin, bws_reOpts));
  return rcpp_result_gen;
  END_RCPP
}
