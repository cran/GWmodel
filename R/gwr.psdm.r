...
gwr.multiscale <- function(formula, data, kernel="bisquare", adaptive=FALSE, criterion="dCVR", max.iterations=1000,threshold=0.000001, dMats, p.vals, theta.vals,longlat=FALSE,
