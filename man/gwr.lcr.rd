...
\usage{
gwr.lcr(formula, data, regression.points, bw, kernel="gaussian",
...
\arguments{
  ...
  \item{lambda.adjust}{a locally-varying ridge parameter. Default FALSE, refers to basic GWR without a local ridge adjustment 
  (i.e. lambda=0, everywhere); if TRUE, use cn.tresh to set the maximum condition number.  
   For locations with a condition number (for its local design matrix) above this user-specified threshold, a local ridge parameter is found.}
...
Harris P, Brunsdon C, Charlton M (2013) Living with collinearity in geographically weighted regression: an assessment of parameter accuracy using simulated data.  In review

Harris P, Brunsdon C, Charlton M (2013) Living with collinearity in geographically weighted regression: an assessment of prediction accuracy using simulated data.  In review
}
